...
CREATE TABLE rental_home (
	...
	state CHAR(1) NOT NULL,
	hosting_start_date DATETIME NOT NULL,
	hosting_end_date DATETIME NOT NULL,
...
-- 국가
ALTER TABLE nation
	ADD CONSTRAINT PK_nation -- 국가 Primary key
	PRIMARY KEY (
	nation_no -- 국가번호
	);
...
ALTER TABLE board_like
	MODIFY COLUMN board_like_no INT NOT NULL AUTO_INCREMENT;
...
ALTER TABLE member_role
	ADD CONSTRAINT FK_role_TO_member_role -- 권한 -> 회원_권한
	FOREIGN KEY (
	role_no -- 권한번호
	)
	REFERENCES role ( -- 권한
...
-- 회원_권한
ALTER TABLE member_role
	ADD CONSTRAINT FK_member_TO_member_role -- 회원 -> 회원_권한
	FOREIGN KEY (
	member_no -- 회원번호
	)
	REFERENCES member ( -- 회원
