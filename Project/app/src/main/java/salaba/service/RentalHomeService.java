...
import salaba.response.RentalHomeModifiedResponse;
...
public class RentalHomeService {
    ...
    public RentalHomeModifiedResponse modifyRentalHome(RentalHomeModifyDto dto) {
        ...
        rentalHome.modifyRentalHome(region, dto.getName(), dto.getExplanation(),
                ...
                dto.getLon(), dto.getHostingStartDate(),
                dto.getHostingEndDate(), dto.getRule(), dto.getCleanFee());
        ...
        return new RentalHomeModifiedResponse(rentalHome);
    }
}
