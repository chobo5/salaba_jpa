...
public class RentalHome implements Serializable { // 숙소
  ...
  private long rentalHomeNo; // 숙소번호
  ...
  private LocalDateTime hostingStartDate; // 호스팅 시작일
  
  private LocalDateTime hostingEndDate; // 호스팅 종료일
  
  private LocalDateTime registeDate; // 숙소 등록일
