...
//    if (!hostService.rentalHomeList(loginUser.getMemberNo()).isEmpty()) {
//      url.append("reservationList?hostNo=").append(loginUser.getMemberNo());
//    } else {
...
//    RentalHome rentalHome = (RentalHome) session.getAttribute("rentalHome");
//    Member loginUser = (Member) session.getAttribute("loginUser");
//    long hostNo = loginUser.getMemberNo();
//    hostService.rentalHomeAdd(rentalHome, hostNo);
//
//    // 숙소 등록 후 임시 정보 값 제거
//    sessionStatus.setComplete();
//
//    return "redirect:rentalHomeList?hostNo=" + loginUser.getMemberNo();
//  }
//
//  // 숙소 관리 리스트
...
//  public String rentalHomeStateUpdate(long rentalHomeNo, char state) {
//
...
//  public void rentalHomeView(long rentalHomeNo, Model model, SessionStatus sessionStatus)
//      throws Exception {
...
//  public void incomeList(Model model, long hostNo) {
...
//  public void reservationList(Model model, long hostNo) {
...
//  //채팅방 리스트
//  @GetMapping("chatList")
//  public void chatList(Model model, long hostNo) {
