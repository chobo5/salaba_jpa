...
//import salaba.service2.BookmarkService;
...
//    if(loginUser != null){
//      int result = bookmarkService.selectOneBookMark(loginUser.getMemberNo(), rentalHomeNo);
//      if( result > 0 ){
...
//  public void rentalHomeReviewList(long rentalHomeNo, Model model ){
//    // 숙소 리뷰 조회
