...
//      memberService.deletePreference(member.getMemberNo());
//      memberService.insertPreference(member);
//    }
//
//    // 업데이트 후 개인정부 다시 불러오기
//    Member newMember = memberService.selectUserInfoForUpdateSession(member.getMemberNo());
//
//    // 세션 정보 삭제 후 재등록
...
//    }
//
//    int numOfRecord = boardService.countAllHistory(loginUser.getMemberNo());
...
//      }
//
//      List<Board> boardList = boardService.boardHistory(pageNo, pageSize, loginUser.getMemberNo());
...
//    }
//
//    int numOfRecord = boardService.countAllCommentHistory(loginUser.getMemberNo());
//    int numOfPage = numOfRecord / pageSize + ((numOfRecord % pageSize) > 0 ? 1 : 0);
//
//    if( numOfRecord > 0 ){
//      if (pageNo > numOfPage) {
...
//      }
//
//      List<Board> commentList = boardService.commentHistory(pageNo, pageSize, loginUser.getMemberNo());
//
