...
//import salaba.service2.RentalHomeService;
//import salaba.service2.ReservationService;
...
//    model.addAttribute("reservationList", reservationService.selectReservationList(loginUser.getMemberNo()));
//  }
//
...
//    if(reservation.getState() == ConstVO.reservation_state_end) {
